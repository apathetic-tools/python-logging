"""RegisterDefaultLogLevel functionality for Apathetic Logger."""
...
class _ApatheticLogger_RegisterDefaultLogLevel:  # noqa: N801  # pyright: ignore[reportUnusedClass]
    ...
    ApatheticLogger.register_default_log_level.
    """
