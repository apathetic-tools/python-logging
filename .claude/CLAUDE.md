...
- **When the developer asks a question**: If the developer asks a question (even if the rest of the prompt implies doing work), you **must**:
...
- **After answering**: Once you've provided the answer and recommendations, ask if you should proceed with implementation. Only proceed after explicit confirmation.
