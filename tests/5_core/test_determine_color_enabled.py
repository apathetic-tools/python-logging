...
"""Tests for apathetic_logging.determine_color_enabled()."""
...
def test_no_color_disables(
    ...
    assert mod_alogs.apathetic_logging.Logger.determine_color_enabled() is False
...
def test_force_color_enables(
    ...
    assert mod_alogs.apathetic_logging.Logger.determine_color_enabled() is True
