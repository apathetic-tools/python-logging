...
"""Tests for ApatheticLogger.determine_color_enabled()."""
...
def test_no_color_disables(
    ...
    assert mod_alogs.ApatheticLogger.determine_color_enabled() is False
...
def test_force_color_enables(
    ...
    assert mod_alogs.ApatheticLogger.determine_color_enabled() is True
