# tests/50_core/test_determine_color_enabled.py
"""Tests for apathetic_logging.determineColorEnabled()."""
...
def test_no_color_disables(
    ...
    assert mod_alogs.Logger.determineColorEnabled() is False
...
def test_force_color_enables(
    ...
    assert mod_alogs.Logger.determineColorEnabled() is True
