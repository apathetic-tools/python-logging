...
@pytest.fixture
def direct_logger() -> mod_alogs.ApatheticLogger:
    ...
    return mod_alogs.ApatheticLogger(name, enable_color=False)


@pytest.fixture
def module_logger(monkeypatch: pytest.MonkeyPatch) -> mod_alogs.ApatheticLogger:
    ...
    """
    new_logger = mod_alogs.ApatheticLogger(
